# Roteiro do Protótipo Navegável — Biblioteca Viva
...
**Link do protótipo:** (https://www.figma.com/design/rgYUfA1fHxxX0ikOd6rTjd/Prot%C3%B3tipo-Naveg%C3%A1vel---Biblioteca-Viva?node-id=0-1&t=3wnTQBS6lAIRODQU-1)
...
|Fila de Reserva| Atendente |#10 | Exibe a ordem da fila de reservas, a data de solicitação e a situação de cada reserva. |
